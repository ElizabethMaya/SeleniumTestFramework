...
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public boolean switchToFrameByClass(WebDriver driver,String classValue) {
		boolean flag = false;
		try {
			driver.switchTo().frame(classValue);
			flag = true;
			return true;
		} catch (Exception e) {
			...
			if (flag) {
				System.out.println("Frame with Id \"" + classValue + "\" is selected");
			} else {
				System.out.println("Frame with Id \"" + classValue + "\" is not selected");
			}
		}
	}
